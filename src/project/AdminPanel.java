...
public class AdminPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.setBackground(new java.awt.Color(0, 140, 255));

        updateButton.setBackground(new java.awt.Color(0, 140, 255));
        ...
        checkStockButton.setBackground(new java.awt.Color(0, 140, 255));
        ...
        billingButton.setBackground(new java.awt.Color(0, 140, 255));
        ...
        mBrand.setForeground(new java.awt.Color(0,50,150));
        ...
        mModel.setForeground(new java.awt.Color(0,50,150));
        ...
        jLabel5.setForeground(new java.awt.Color(0, 50, 150));
        ...
        mQty.setForeground(new java.awt.Color(0,50,150));
        ...
        jLabel6.setForeground(new java.awt.Color(0, 50, 150));
        ...
        mPhotoPath.setForeground(new java.awt.Color(0, 50, 150));
        ...
        mCat.setForeground(new java.awt.Color(0, 50, 150));
        mCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Men", "Women" }));
        ...
        mDescription.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0,50,150), 1, true));
        ...
        photoSelection.setBackground(new java.awt.Color(0, 140, 255));
        ...
        mPrice.setForeground(new java.awt.Color(0,50,150));
        ...
        jLabel10.setForeground(new java.awt.Color(0,50,150));
        ...
        stockStatusCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Men", "Women" }));

        updateStockButton.setBackground(new java.awt.Color(0,140,255));
        ...
        delUpdateCat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Men", "Women"}));
    ...
    private void checkStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkStockButtonActionPerformed
            ...
            ArrayList<ProductList> list = MenDB.checkStock();
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        try{
            if(mCat.getSelectedItem().equals("Women")){
            if(!path.equals(""))
                WomenDB.insertIntoWomenDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        }
        
        else if(mCat.getSelectedItem().equals("Men")){
            if(!path.equals(""))
                MenDB.insertIntoMenDB(mBrand.getText(), mModel.getText(), Integer.parseInt(mPrice.getText()), 
                        Integer.parseInt(mQty.getText()), mDescription.getText(), path);
        } 
        mBrand.setText("");
        mModel.setText("");
    ...
    private void updateStockButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateStockButtonActionPerformed
        try{
            ...
            if(stockStatusCat.getSelectedItem().equals("Men")){
                MenDB.flag = true;
                MenDB.updateMenDB(model, qty);
            }

            else if(stockStatusCat.getSelectedItem().equals("Women")){
                WomenDB.flag = true;
                WomenDB.updateWomenDB(model, qty);
            }            
    ...
    private void delEntryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delEntryActionPerformed
        ...
        if(delUpdateCat.getSelectedItem().equals("Men")){
            MenDB.delete(del);
        }
        else if(delUpdateCat.getSelectedItem().equals("Women")){
            WomenDB.delete(del);
        }
